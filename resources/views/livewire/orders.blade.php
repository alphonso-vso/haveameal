        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="odd:bg-white even:bg-gray-100 bg-white border-b hover:bg-gray-100">
                    <td class="px-6 py-3">{{ $order->costumer }}</td>
                    <td class="px-6 py-3">{{ $order->meal }}</td>
                    <td class="px-6 py-3">₡{{ $order->price * $order->quantity }}</td>
                    <td class="px-6 py-3">₡{{ $order->additional * $additionalPrice->price }}</td>
                    <td class="px-6 py-3">₡{{ ($order->price * $order->quantity) + ($order->additional * $additionalPrice->price) }}</td>
                    <td class="px-6 py-3">
